...
class Class(Attribute):
    ...
    ``classes`` - default classes to start with
    '''
    ...
    def __add__(self, other: Union[str, Iterable[str], Class]) -> Class:
        ...
        if isinstance(other, Iterable): return self.__class__(classes=self.value | set(other))
    ...
    def __next__(self) -> str: return next(self.value)
